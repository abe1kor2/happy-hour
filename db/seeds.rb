  ...
  r6.deals.create!([
    {
      ...
      start_time: "17:00",
      end_time: "19:00",
      description: "Happy Hour Tuesday – Saturday 5-7 pm. Plus check out their Happy Hour bites menu"
    },
    {
      day: ["Sunday", "Monday"],
      start_time: "17:00",
      end_time: "21:00",
      description: "Happy Hour Sunday & Monday 5-9 pm. Plus check out their Happy Hour bites menu"
    }
  ])
end
  ...
  r9.deals.create!([
    {
      ...
      start_time: "16:00",
      end_time: "19:00",
      description: "Make Time for Happy Hour! 4–7pm"
    },
    {
      day: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
      start_time: "23:00",
      end_time: "23:59",
      description: "Make Time for Happy Hour! 11pm–1am"
    }
  ])
end
  ...
  r10.deals.create!([
    {
      ...
      start_time: "14:00",
      end_time: "16:00",
      description: "Mimosa Mondays $6.00"
    },
    {
      day: ["Tuesday"],
      start_time: "14:00",
      end_time: "16:00",
      description: "Tinto Tuesdays $8.00"
    },
    {
      day: ["Wednesday"],
      start_time: "14:00",
      end_time: "16:00",
      description: "Wine Wednesdays $8.00"
    },
    {
      day: ["Thursday"],
      start_time: "14:00",
      end_time: "16:00",
      description: "Thirsty Thursdays $8.00"
    },
    {
      day: ["Friday"],
      start_time: "14:00",
      end_time: "16:00",
      description: "Frosty Fridays $5.00"
    },
    {
      day: ["Saturday"],
      start_time: "14:00",
      end_time: "16:00",
      description: "Spritz Saturdays $8.00"
    },
    {
      day: ["Sunday"],
      start_time: "14:00",
      end_time: "16:00",
      description: "Caesar Sundays $6.00"
    }
  ])
end
